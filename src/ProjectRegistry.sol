...
contract ProjectRegistry {
    ...
    function submitProject(string memory _projectName, string memory _projectCategory, string memory _projectDescription, uint256 _fundingGoal, string memory _projectObjectives, ProjectReturnType _projectReturnType) public {
        ...
        projectIdToProject[_projectId] = Project(_projectId, _projectOwner, _projectName, _projectCategory, _projectDescription, _createdAt, _fundingGoal, _projectObjectives, _projectReturnType, _projectStatus);
        totalProjects ++;
